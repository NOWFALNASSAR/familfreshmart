...
export async function GET() {
  ...
  try {
    const [parties, entries, closings, audit, settings, users] = await Promise.all([
    ...
    return NextResponse.json({ me, parties, entries, closings, audit, settings: settings[0], users });
  } catch (e) {
